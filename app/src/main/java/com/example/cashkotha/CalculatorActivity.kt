...
import com.example.cashkotha.databinding.ActivityCalculatorBinding
...
class CalculatorActivity : AppCompatActivity() {
    ...
    private fun showVatCalculator() {
        findViewById<MaterialCardView>(R.id.vatCalculatorCard).visibility = View.VISIBLE
        findViewById<MaterialCardView>(R.id.discountCalculatorCard).visibility = View.GONE
        findViewById<MaterialCardView>(R.id.cashbackCalculatorCard).visibility = View.GONE
    }

    private fun showDiscountCalculator() {
        findViewById<MaterialCardView>(R.id.vatCalculatorCard).visibility = View.GONE
        findViewById<MaterialCardView>(R.id.discountCalculatorCard).visibility = View.VISIBLE
        findViewById<MaterialCardView>(R.id.cashbackCalculatorCard).visibility = View.GONE
    }
    ...
    private fun showCashbackCalculator() {
        findViewById<MaterialCardView>(R.id.vatCalculatorCard).visibility = View.GONE
        findViewById<MaterialCardView>(R.id.discountCalculatorCard).visibility = View.GONE
        findViewById<MaterialCardView>(R.id.cashbackCalculatorCard).visibility = View.VISIBLE
    }
    ...
    private fun calculateVAT() {
        ...
        vatResultCard.visibility = View.VISIBLE
    ...
    private fun calculateDiscount() {
        ...
        discountResultCard.visibility = View.VISIBLE
    ...
    private fun calculateCashback() {
        ...
        cashbackResultCard.visibility = View.VISIBLE
